...
- Shopify homepage washroom is the Eurus Lookbook; patched `shopify/sections/lookbook.liquid` adds a mobile image (`bathroom-map-mobile.jpg`) and per-hotspot mobile positions—replace the theme lookbook file, then set Mobile image in the theme editor
